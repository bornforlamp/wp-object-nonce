...
class Nonce_Url_GeneratorTest extends TestCase
{
	...
	* @var    object $test_nug The default test generator object.
	...
	protected function setUp() {
 		...
 		$this->test_nonce = \bornforlamp\nonce\wp_create_nonce( $this->test_action );
 	}
 	...
 	*/
 	public function test_generate_nonce_url(){
		...
		$url_generated = $this->test_nug1->generate_nonce_url( 'https://harshadmane.in' );

		// Building the expected url.
		$url_expected = 'https://harshadmane.in?_wpnonce='. $this->test_nonce;
